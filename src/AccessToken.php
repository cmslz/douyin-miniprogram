...
class AccessToken  implements RefreshableAccessTokenInterface
{
    ...
    public function __construct(
        ...
        $this->cache = $cache ?? new Psr16Cache(new FilesystemAdapter(namespace: 'cmslz', defaultLifetime: 1500));
    }
    ...
    /**
     * @throws \Cmslz\DouyinMiniProgram\Kernel\Exceptions\HttpException
