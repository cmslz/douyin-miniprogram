...
use Cmslz\DouyinMiniProgram\Kernel\ServerResponse;
use Cmslz\DouyinMiniProgram\Kernel\Traits\DecryptXmlMessage;
use Cmslz\DouyinMiniProgram\Kernel\Traits\InteractWithHandlers;
use Cmslz\DouyinMiniProgram\Kernel\Traits\RespondXmlMessage;
...
class Server implements ServerInterface
{
     ...
     * @throws BadRequestException
     */
    public function getRequestMessage(ServerRequestInterface $request = null): \Cmslz\DouyinMiniProgram\Kernel\Message
    {
     ...
     * @throws RuntimeException
     */
    public function getDecryptedMessage(ServerRequestInterface $request = null): \Cmslz\DouyinMiniProgram\Kernel\Message
    {
